...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_gazebo_SOURCE_PREFIX /home/robond/Desktop/workspace/ekf_lab/src/turtlebot_simulator/turtlebot_gazebo)
  set(turtlebot_gazebo_DEVEL_PREFIX /home/robond/Desktop/workspace/ekf_lab/devel)
  ...
  set(turtlebot_gazebo_INSTALL_PREFIX /home/robond/Desktop/workspace/ekf_lab/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/Desktop/workspace/ekf_lab/src/turtlebot_simulator/turtlebot_gazebo/${idir}'.  Ask the maintainer 'Marcus Liebhardt <marcus.liebhardt@yujinrobot.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robond/Desktop/workspace/ekf_lab/devel/lib;/home/robond/Desktop/workspace/ekf_lab/devel/lib;/opt/ros/kinetic/lib)
